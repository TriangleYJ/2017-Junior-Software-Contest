...
public class IntroActivity extends AppIntro {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        addSlide(AppIntroFragment.newInstance("쉽고 간단한 색각이상 검사", "이시하라 색각 이상 검사를 통하여 당신이 어떤 색각이상을 가지고 알 수 있습니다. ", R.drawable.aw, getResources().getColor(R.color.colorPrimary)));
        ...
        addSlide(AppIntroFragment.newInstance("화면상의 모든 것을 순식간에 캡쳐", "앱이 백그라운드에서 동작할 시 눈 모양의 아이콘을 띄웁니다. 클릭 시 화면을 캡쳐한 후 필터링을 하게 됩니다. x 버튼을 누를 시 이 버튼을 띄우지 않습니다.", R.drawable.ae, getResources().getColor(R.color.colorPrimary)));
